...
// Auth is now handled via hardcoded credentials in AuthContext.tsx
// This function is kept for backwards compatibility but always returns null
// since we no longer use Supabase Auth.
export async function getCurrentUserRole(): Promise<'admin' | 'viewer' | null> {
  return null
}